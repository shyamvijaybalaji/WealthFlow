...
<div class="flex min-h-screen">
	...
	<main class="flex-1 px-4 pt-20 pb-4 sm:p-6 md:p-8">
		...
		<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 md:mb-8">
			<div>
				<h1 class="text-3xl md:text-4xl font-bold gradient-text mb-1 md:mb-2">Transactions</h1>
				<p class="text-sm md:text-base text-white/70">Track your income and expenses</p>
			</div>
			{#if accounts.length > 0}
